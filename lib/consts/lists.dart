...
const featuredImages1 = [imgKambing1, imgSapi, imgDomba2];
const featuredImages2 = [imgKambing2, imgDomba1, imgS6];

const freaturedTitles1 = [kambingQ,sapiQ,dombaQ];
const freaturedTitles2 = [kambingA, dombaA, all];
